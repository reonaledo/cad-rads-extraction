...
def validate_data_files():
    ...
    required_files = {
        f'sample_processed_internal_test_50_{VERSION}.csv': "test data",
...
def run_experiment(N_SHOT, SEED):
    ...
    filename = os.path.join(RESULTS_DIR, f'result_1028_{API}_InterTest_{VERSION}_{TAG}_{timestamp}.xlsx')
...
def main():
    ...
    print(f"Estimated remaining time: {(total_experiments - completed_count) * 5} minutes (approximate)")
